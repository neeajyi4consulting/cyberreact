...
export default function CardCreateChapter({ color, handleClose, submitClose }) {
  ...
  const handleAddChapter = async (e) => {
    ...
    if (!courseLink || courseLink === "" || !regex.test(courseLink))
      return toast.error("Please Enter Valid Chapter URL");
    ...
    data.append("extra_file", attachment);
    ...
    addChapter(data)
      ...
      .catch((err) => {
        console.log("error in add chapter", err.response);
...
CardCreateChapter.defaultProps = {
  color: "light",
};

CardCreateChapter.propTypes = {
